...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            background-color: #343a40; padding-top: 60px;
        }
        .sidebar a {
            color: #adb5bd; text-decoration: none; display: block; padding: 10px 15px;
        }
        ...
        .header {
            ...
            background-color: #212529; color: white; display: flex; align-items: center;
...
<div class="sidebar">
    ...
    <a href="${ctx}/orders" class="${active eq 'orders' ? 'active' : ''}">🧾 Đơn hàng</a>
    <!-- Đổi sang servlet -->
