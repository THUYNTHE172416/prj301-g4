...
public class InvoiceController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (idStr == null || idStr.isBlank()) {
            resp.sendRedirect("checkout?msg=missing_invoice_id");
            return;
        }
        ...
        try {
            ...
            resp.sendRedirect("checkout?msg=invalid_invoice_id");
            return;
        }
        ...
        if (order == null) {
            resp.sendRedirect("checkout?msg=invoice_not_found");
            return;
        }
        List<OrderDetail> details = dao.findOrderDetails(id);
